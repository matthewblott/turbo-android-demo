...
@TurboNavGraphDestination(uri = "turbo://fragment/web/customers")
open class WebCustomersFragment : TurboWebFragment(), NavDestination {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
    return inflater.inflate(R.layout.fragment_web_customers, container, false)
  }
